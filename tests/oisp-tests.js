...
describe("OISP E2E Testing", function() {
    ...
    it('Shall create switch-on rule', function(done) {
        ...
        helpers.createRule(rules[switchOnCmdName], 0, userToken, accountId, deviceId, function(err, id) {
            if (err) {
    ...
    it('Shall create switch-off rule', function(done) {
        ...
        helpers.createRule(rules[switchOffCmdName], 0, userToken, accountId, deviceId, function(err, id) {
            if (err) {
